...
lme_global_b_s = lme(resid ~ iem.summ.temp + iem.summ.rain.10 + 
                       iem.summ.temp * PropMoose +
                       iem.summ.temp * PropHare +
                       iem.summ.temp * PropPtarmagin +
...
step6_s_s = lme(resid ~ iem.summ.temp +
                  iem.summ.temp * PropPtarmagin +
                  PropPtarmagin,
                data = sd_salix_cch_S, random = ~ 1|Section/ShrubID, method = "ML")
...
axis(3,at=0.5:6,las=1,labels=c("Full\n Model", "Step 1", "Step 2", "Step 3", "Step 4", "Minimal\nAdequate\nModel"))
...
mtext('Salix spp. Model Selection', side=3, line=3, padj = 2, at = -1.2, cex = 1.25)
